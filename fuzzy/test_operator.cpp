...
void test_IsGaussian (){
    ...
    float mean = 3.4;
    float stdDev = 0.7;
    fuzzy::IsGaussain<float> op(mean,stdDev);
    ...
    if(eval1 == expected1 && eval2 == expected2 && eval3 == expected3){
        std::cout << "IsGaussain operator OK" << std::endl;
    } else {
        std::cout << "IsGaussian operator FAILED" << std::endl;
    }

}

void test_IsRectangle(){
    ...
    float start = 2;
    float end = 4;
    fuzzy::IsRectangle<float> op(start,end);
    ...
    if(eval1 == expected1 && eval2 == expected2 && eval3 == expected3 && eval4 == expected4){
        std::cout << "IsRectangle operator OK" << std::endl;
    } else {
        std::cout << "IsRectangle operator FAILED" << std::endl;
    }
}
...
void test_IsSigmoid(){
    ...
    core::ValueModel<float> *vm1 = new core::ValueModel<float>(v1);
    core::ValueModel<float> *vm2 = new core::ValueModel<float>(v2);
    core::ValueModel<float> *vm3 = new core::ValueModel<float>(v2);

    float pente = 0.7;
    float inflection= 4;
    fuzzy::IsSigmoid<float> op(pente,inflection);
    ...
    if(eval1 == expected1 && eval2 == expected2 && eval3 == expected3){
        std::cout << "IsSigmoid operator OK" << std::endl;
    } else {
        std::cout << "IsSigmoid operator FAILED" << std::endl;
    }
}
...
void test_IsBell(){
    ...
    float center= 4;
    float mid = 6;
    fuzzy::IsBell<float> op(min,mid,center);
    ...
    if(eval1 == expected1 && eval2 == expected2 && eval3 == expected3){
        std::cout << "IsBell operator OK" << std::endl;
    } else {
        std::cout << "IsBell operator FAILED" << std::endl;
    }
}
